...
- 對話識別碼：`conv_6c043c66a0c24a94918bcf15e316032c`
- 活動規劃版本：`2`
- 已保存訊息數：`4`
- 字卡內容：AI 行銷活動規劃；已依客群條件完成 CRM 預覽並建立活動草稿。；活動主題；沉睡會員蛋糕喚回活動；目標客群；一般挽留客；預估客群；21 人；優惠內容；9 折；建議通路；store；CRM 草稿；32
