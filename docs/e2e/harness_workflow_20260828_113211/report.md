...
| 步驟 | 驗證內容 | 結果 | 截圖 |
| --- | --- | --- | --- |
| 1. 複合需求與受控 Tool Chain | 三階段 cards：營運洞察、活動規劃、策略研究；三個可驗證步驟皆 completed；保留建立草稿 action，但未出現 send_coupon | **PASS** | ![02_compound_workflow_progress](02_compound_workflow_progress.png) |
| 2. 動態客群條件 DSL | typed Tool = preview_audience；回應卡顯示 v1 DSL 的 AND 條件摘要；包含年齡、性別、消費期間、LINE 綁定共 4 條白名單規則 | **PASS** | ![03_dynamic_audience_dsl](03_dynamic_audience_dsl.png) |
| 3. CRM 能力目錄 | typed Tool = get_crm_capabilities；回傳能力與限制資訊卡 | **PASS** | ![04_crm_capabilities](04_crm_capabilities.png) |
| 4. 人工確認邊界 | 草稿建立保留給使用者確認 | **PASS** | ![05_manual_confirmation_boundary](05_manual_confirmation_boundary.png) |
...
[
  {
    ...
    "input": {
      "message": "先分析去年母親節，再規劃今年母親節活動，提供 LINE 會員專屬優惠，並比較提前四週與提前兩週。",
      "request": {
        "message": "先分析去年母親節，再規劃今年母親節活動，提供 LINE 會員專屬優惠，並比較提前四週與提前兩週。",
    ...
    "output": {
      ...
      "workflow": {
        ...
        "event_name": "母親節",
        "historical_report_id": "historical-insight-2025-04-01-2025-05-31-all",
        "source_text": "先分析去年母親節，再規劃今年母親節活動，提供 LINE 會員專屬優惠，並比較提前四週與提前兩週。",
        "revision": 1,
        "next_actions": [
        ...
        "research_query": {
          ...
          "hypothesis": "提前四週分階段觸達，會比提前兩週帶來更高增量轉換。",
      ...
      "reply": {
        "text": "我已依序完成去年母親節基線分析、今年活動規劃，並建立提前四週與提前兩週的策略研究設定。活動草稿尚未建立，請先確認規劃內容。",
        "confidence": 10,
        "progress": [
          {
            "key": "historical",
        ...
        "cards": [
          ...
          },
          {
            ...
            "items": [
              ...
              {
                "label": "研究假設",
                "value": "提前四週分階段觸達，會比提前兩週帶來更高增量轉換。",
                "trend": "unavailable",
                "status": "info"
              },
              {
        ...
        "reports": [
          {
            "report_id": "historical-insight-2025-04-01-2025-05-31-all",
            "title": "去年檔期行銷分析報告",
          ...
          {
            "report_id": "strategy-design-pending-campaign",
            "title": "AI 行銷活動策略研究設定",
  ...
  },
  {
    "step": "2. 動態客群條件 DSL",
    "input": {
      "message": "找出女性 28歲到35歲、近90天有消費，而且已綁定 LINE 的會員",
      "request": {
        "message": "找出女性 28歲到35歲、近90天有消費，而且已綁定 LINE 的會員",
        "conversation_id": "conv_3dc39ed69a6e43a7bfa6bc00ecf324bd",
        "timezone": "Asia/Taipei",
        "context": {
          "store_codes": []
        }
    ...
    "output": {
      ...
      "reply": {
        "text": "CRM 客群預覽完成，目前有 1 位會員符合女性 AND 年齡 28 至 35 歲 AND 最近消費天數至多90 AND 已綁定 LINE。",
        "confidence": 10,
        "progress": [],
        "cards": [
          {
            ...
            "title": "CRM 客群預覽",
            "description": "這是唯讀預覽，尚未建立活動或發送訊息。",
            "items": [
              {
                "label": "符合會員",
                "value": "1 人",
              ...
              {
                "label": "篩選條件",
                "value": "女性 AND 年齡 28 至 35 歲 AND 最近消費天數至多90 AND 已綁定 LINE",
                "trend": "unavailable",
                "status": "info"
              },
              {
  ...
  },
  {
    ...
    "output": {
      ...
      "resolved_intent": {
        ...
        "tool": {
          "tool": "get_crm_capabilities"
        }
      },
      "workflow": null,
      "reply": {
        "text": "目前已連線 aposo_crm（demo），共確認 3 項能力，其中 2 項可直接使用。",
        "confidence": 10,
        "progress": [],
        "cards": [
          {
            ...
            "title": "CRM 可用能力",
            "description": "後續回答會以這份能力目錄限制可用的 CRM 工具與資料範圍。",
            "items": [
              {
                "label": "audience_preview",
                "value": "可用",
                "trend": "unavailable",
                "status": "normal",
                "description": "支援：rfm、product_keyword、age_range、gender、line_bound"
              },
              {
                ...
                "trend": "unavailable",
                "status": "unavailable",
                "description": "支援：product、store、channel、revenue；限制：毛利與同期比較需有對應報表資料"
              },
              {
                "label": "campaign_execution",
                "value": "可用",
                "trend": "unavailable",
                "status": "normal",
                "description": "支援：draft、coupon_issue、metrics；限制：實際發送仍需使用者確認"
              }
            ]
          }
        ],
    ...
    "assertions": [
      "typed Tool = get_crm_capabilities",
      "回傳能力與限制資訊卡"
    ]
  },
  {
